...
def send_messages(client_color, client_socket, client_name):
...
def main():
    global dead_server, client_name
    ...
    if client_socket:
        ...
        sender_process = multiprocessing.Process(target=send_messages,
                                                 args=(client_color, client_socket, lambda: client_name, ))
